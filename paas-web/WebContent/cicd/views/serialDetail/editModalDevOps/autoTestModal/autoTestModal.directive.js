...
//编辑弹窗
  angular.module('PaaS5')
    .directive('autoTestModal', function (CORE_VALUE,$http,COREDATA) {
      return {
        restrict: 'EA',
        templateUrl: CORE_VALUE.pageUrlPrefix + 'views/serialDetail/editModalDevOps/autoTestModal/autoTestModal.html',
        scope: {
          init: '&'
        },
        replace: false,
        link: function (scope, element, attrs) {
          ...
          scope.queryData = function() {
            $http({
              method: 'GET',
              url: '/paas/autotest/queryAutoTest.action',
              params: queryParams
          ...
          scope.save = function() {
            ...
            $http({
              method: 'POST',
              url: '/paas/autotest/updateAutoTest.action',
              data: {autoTestInfo:autoTestInfo},
              headers: {'Content-Type': 'application/x-www-form-urlencoded'}
            }).success(function (res) {
              if (res.resultCode + '' === '200'){
                $('#cancelId').click();
