...
<script type="text/javascript">
	$(function() {
		...
		b.href = "dataCenterList.jsp";
		var c = document.getElementById("c");
		c.href = "${ctx}/sysAlarm/queryAlarmCondition.action";
		var c = document.getElementById("d");
		c.href = "imageSyncList.jsp";
	});
</script>
...
<div class="Monitor-right-title">
	<ul>
		...
		<li><a target="bbb" id="a" href="">全局监控</a></li>
		<li><a target="bbb" id="b" href="">数据中心</a></li>
		<li><a target="bbb" id="c" href="">告警</a></li>
		<li><a target="bbb" id="d" href="">镜像同步</a></li>
	</ul>
</div>
