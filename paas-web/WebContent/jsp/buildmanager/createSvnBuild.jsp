	    ...
	    <div class="dialog-configure" id="mainDiv">
	        ...
	        <div class="structure-code" id="addRepositoryDiv">
	        	<div class="add-build-title">
	        		...
	        		<span><img src="${ctx}/imgs/build-tips.png" width="15" height="15" title="1）、当有多个svn库时，代码目录之间不能存在目录包含                 &#13;2）、Dockerfile文件中的文件路径也是以代码目录开头的相对路径 "/></span>
	        	</div>
	        	<s:iterator value="buildEntity.repositoryInfo" status="st">
		            <div class="code-main" style="border-radius:0 5px 5px 5px;" id="repositoryDiv<s:property value='#st.index'/>">
		                ...
		                <ul>
		                    <li style="width:250px;"><span style="margin-left:20px;"><strong>*</strong>svn地址：</span><input name="buildEntity.repositoryInfo[<s:property value='#st.index'/>].url" id="url<s:property value='#st.index'/>" type="text" value='<s:property value="url"/>' style="width:120px;" onblur="getRepositoryInfo(<s:property value='#st.index'/>);verifyRepositoryInfo(<s:property value='#st.index'/>)" onmouseover="toolTips(this);"/></li>
