...
<script language="JavaScript" type="text/javascript">
	var isClose = '<%=request.getParameter("isClose") %>';
	$(function(){
		if(isClose == "true" || isClose){
			$("#closeBtn").hide();
		}
	});
	</script>
...
<body>
	<div class="alert">
		<div class="alert-main">
			<div class="alertWarn-title">
				<h1><img src="${ctx}/imgs/Check-failure.png" width="36" height="30" style="margin-right:5px; margin-bottom:-5px;"/>提示！</h1>
				<span id="closeBtn">
