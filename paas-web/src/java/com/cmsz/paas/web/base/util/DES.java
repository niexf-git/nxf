...
* 加密，解密算法
* @author venus
* @version 创建时间：2016年11月22日 下午4:35:05
*
*/
public class DES {
  ...
  public static void main(String[] args) throws Exception {
  	...
  	String encryptString = "123qwe";
  	System.out.println("原始串："+encryptString);
  	String decryptString = DES.getInstance().encrypt("123qwe");
  	System.out.println("加密后："+decryptString);
  	System.out.println("解密后："+DES.getInstance().decrypt(decryptString));
	}
