...
public class SqlSessionFactoryFactoryBeanSonar implements FactoryBean, InitializingBean {
    
    Log logger = LogFactory.getLog(SqlSessionFactoryFactoryBeanSonar.class);
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        sqlSessionFactorySonar = createSqlSessionFactory();
    }
	...
	private SqlSessionFactory createSqlSessionFactory() throws IOException {
        ...
        try {
            SqlSessionFactory sqlSessionFactorySonar = new SqlSessionFactoryBuilder().build(reader);
            Configuration conf = sqlSessionFactorySonar.getConfiguration();
            if (dataSource != null) {
                ...
                conf.setEnvironment(new Environment("development", new ManagedTransactionFactory(),
                        dataSourceToUse));
                sqlSessionFactorySonar = new SqlSessionFactoryBuilder().build(conf);
            }
