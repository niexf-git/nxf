...
public class Instance implements Serializable{
	...
	public String toString() {
		return "Instance [id=" + id + ", containerId=" + containerId
				+ ", createTime=" + createTime + ", startedAt=" + startedAt
				+ ", status=" + status + ", hostIp=" + hostIp
				+ ", restartCount=" + restartCount + ", suggestMsg="
				+ suggestMsg + ", websshUrl=" + websshUrl + "]";
	}
