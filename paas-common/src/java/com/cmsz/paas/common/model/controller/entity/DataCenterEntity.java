...
public class DataCenterEntity implements Serializable{
	...
	public String toString() {
		return "DataCenterEntity [id=" + id + ", name=" + name + ", isMain="
				+ isMain + ", ipaasHaproxyUrl=" + ipaasHaproxyUrl
				+ ", appHaproxyUrl=" + appHaproxyUrl + ", harborUrl="
				+ harborUrl + ", registryUrl=" + registryUrl + ", harborUser="
				+ harborUser + ", harborPwd=" + harborPwd + ", harborTargetId="
				+ harborTargetId + ", description=" + description
				+ ", insertTime=" + insertTime + ", flumeIp=" + flumeIp
				+ ", clusters=" + clusters + "]";
	}
